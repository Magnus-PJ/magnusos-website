...
export default function HISResults() {
  return (
    <section className="section-padding bg-gradient-to-br from-primary-50/30 via-white to-healthcare-50/30 relative overflow-hidden">
      {/* AI Circuit Background Pattern */}
      <div className="absolute inset-0 opacity-5">
        <svg className="w-full h-full" viewBox="0 0 100 100" preserveAspectRatio="none">
          <defs>
            <pattern id="his-circuit" x="0" y="0" width="20" height="20" patternUnits="userSpaceOnUse">
              <path d="M0,10 L20,10 M10,0 L10,20" stroke="currentColor" strokeWidth="0.5" fill="none"/>
              <circle cx="10" cy="10" r="1" fill="currentColor"/>
            </pattern>
          </defs>
          <rect width="100" height="100" fill="url(#his-circuit)"/>
        </svg>
      </div>
      ...
      <div className="container-padding max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-20">
            ...
            >
              ...
              <span className="block text-transparent bg-clip-text bg-gradient-to-r from-primary-600 to-healthcare-600">
        ...
        >
          <div className="text-center mb-12">
            <h3 className="text-3xl font-bold text-gray-900 mb-4">Success Stories from the Field</h3>
        ...
        >
          <div className="text-center mb-12">
            <h3 className="text-3xl font-bold text-gray-900 mb-4">Before vs. After MagnusOS</h3>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
