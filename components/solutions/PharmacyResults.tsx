...
const metrics = [
  {
    ...
    title: '50%',
    subtitle: 'Faster Prescription Processing',
  ...
  },
  {
    icon: ClockIcon,
    title: '30%',
    subtitle: 'Reduced Inventory Costs',
  ...
  },
  {
    icon: UserGroupIcon,
    title: '40%',
    subtitle: 'Improved Patient Engagement',
    description: 'Automated communication and personalized care',
    color: 'healthcare'
  },
  {
    ...
    description: 'Better inventory management and patient retention',
    color: 'warning'
  }
]
...
const testimonials = [
  {
    quote: "MagnusOS Pharmacy helped us reduce prescription processing time by 50% and eliminate drug interaction errors. The AI-powered validation is a game-changer for our pharmacy.",
  ...
  {
    quote: "The automated inventory management and patient engagement features have transformed how we operate. Our staff can focus on patient care instead of routine tasks.",
    ...
    <section className="section-padding bg-gradient-to-br from-gray-50 to-white">
      <div className="container-padding max-w-7xl mx-auto">
        ...
        <div className="text-center mb-20">
          ...
          >
            Proven Results Across Pharmacy Networks
          </motion.h2>
          <motion.p 
          ...
          >
            Pharmacies using MagnusOS have reported measurable improvements in efficiency, 
            ...
            >
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-warning-600 font-medium">{testimonial.pharmacy}</div>
                </div>
              </div>
              <div className="mt-4">
                <span className="inline-block px-3 py-1 text-xs font-medium bg-warning-100 text-warning-800 rounded-full">Pharmacy Management</span>
              </div>
            </motion.div>
          ))}
        </div>
        ...
        >
          <div className="text-center mb-12">
            <h3 className="heading-3 mb-4">Proven Results Across Pharmacy Sectors</h3>
        ...
        >
          <h3 className="heading-3 mb-4">Ready to Transform Your Pharmacy?</h3>
          <p className="body-large mb-8 max-w-2xl mx-auto">Join leading pharmacies that have already embraced the future with MagnusOS</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="btn-primary">Schedule Pharmacy Demo</button>
            <button className="btn-outline">Download Pharmacy Brochure</button>
          </div>
        </motion.div>
      </div>
    </section>
