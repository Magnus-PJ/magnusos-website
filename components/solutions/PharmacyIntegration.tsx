...
const integrations = [
  {
    ...
    description: 'Seamless integration with HIS for patient data, prescriptions, and medication history.',
    benefits: ['Real-time patient data sync', 'Integrated prescription management', 'Medication history tracking']
  },
  {
    icon: CpuChipIcon,
    title: 'Pharmacy Equipment',
    description: 'Direct connectivity with automated dispensing systems and barcode scanners.',
    benefits: ['Automated medication dispensing', 'Real-time inventory sync', 'Barcode verification']
  },
  {
    icon: CloudIcon,
  ...
  },
  {
    ...
    description: 'Open API architecture for integration with existing pharmacy and healthcare systems.',
...
const compliance = [
  ...
  { standard: 'FDA', status: 'Certified', description: 'Food and Drug Administration' },
  { standard: 'DEA', status: 'Registered', description: 'Drug Enforcement Administration' },
  { standard: 'ISO 27001', status: 'Compliant', description: 'Information security' }
]
    ...
    <section className="section-padding bg-white">
      <div className="container-padding max-w-7xl mx-auto">
        ...
        <div className="text-center mb-20">
          ...
          >
            MagnusOS Pharmacy integrates seamlessly with your existing healthcare ecosystem while maintaining 
