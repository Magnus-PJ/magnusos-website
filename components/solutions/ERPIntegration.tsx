...
const integrations = [
  {
    ...
    description: 'Seamless integration with HIS for patient data, operations, and resource management.',
    benefits: ['Real-time data synchronization', 'Integrated workflow management', 'Unified reporting system']
  },
  {
    icon: CpuChipIcon,
    title: 'Third-Party Systems',
    description: 'Direct connectivity with existing healthcare and business systems.',
    benefits: ['API-first architecture', 'Custom integration support', 'Real-time data exchange']
  },
  {
    icon: CloudIcon,
  ...
  },
  {
    ...
    description: 'Seamless integration with existing legacy healthcare systems and databases.',
    benefits: ['Legacy system compatibility', 'Data migration support', 'Backward compatibility']
  }
]

const compliance = [
  { standard: 'HIPAA', status: 'Compliant', description: 'Patient privacy protection' },
  { standard: 'SOX', status: 'Compliant', description: 'Sarbanes-Oxley Act' },
  { standard: 'ISO 27001', status: 'Certified', description: 'Information security' },
  { standard: 'GDPR', status: 'Compliant', description: 'Data protection' }
]
    ...
    <section className="section-padding bg-white">
      <div className="container-padding max-w-7xl mx-auto">
        ...
        <div className="text-center mb-20">
          ...
          >
            MagnusOS ERP integrates seamlessly with your existing healthcare ecosystem while maintaining 
