      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
            Upcoming <span className="bg-gradient-to-r from-primary-600 to-healthcare-600 bg-clip-text text-transparent">Webinars</span>
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Join our expert-led webinars to learn about the latest trends and best practices in healthcare technology.
          </p>
        </motion.div>
        ...
        <div className="bg-gradient-to-br from-primary-50 to-healthcare-50 rounded-2xl p-8 shadow-lg border border-primary-100">
          <p className="text-center text-gray-600 mb-8">
            Webinar schedule coming soon. Stay tuned for expert insights on healthcare technology and AI innovation.
          </p>
