      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-gray-900 mb-6">
            ...
            <br />
            <span className="text-gray-800">Healthcare Together</span>
          </h1>
          
          <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-4xl mx-auto leading-relaxed">
            Ready to revolutionize your healthcare organization? Our experts are here to help you 
            implement AI-powered solutions that drive better patient outcomes and operational efficiency.
          </p>
        </motion.div>
        ...
        >
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-primary-100">
            ...
            <p className="text-gray-600">contact@magnusos.ai</p>
          </div>
